<template>
    ...
    <div class="guideWrapper" :style="{ marginTop: (user && hero) ? '7rem' : null }">
        ...
        <article class="gameGuide">
            ...
            <h3 class="headline bold">- Character Stats -</h3>
            <p class="headline bold">[Hitpoints]</p>
            ...
            <p class="headline bold">[Base Attributes - Strength]</p>
            ...
            <p class="headline bold">[Base Attributes - Speed]</p>
            ...
            <p class="headline bold">[Base Attributes - Vitality]</p>
            ...
            <p class="headline bold">[Weapon Skills]</p>
            ...
            <p class="headline bold">[Skill - Block]</p>
